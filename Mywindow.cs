...
namespace LearningOpenTK
{
    ...
    class Window3D : GameWindow
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            // set perspective
            Matrix4 perspectiva = Matrix4.CreatePerspectiveFieldOfView(MathHelper.PiOver3, (float)this.Width / (float)this.Height, 1, 1024);
        ...
        private void DisplayHelp()
        {
            ...
            Console.WriteLine(" (Q,E) - deplasare camera sus/jos");
            Console.WriteLine(" (Mouse Left Click) - ploaie de obiecte");
            Console.WriteLine(" (Mouse Right Click) - sterge toate obiectele din scena");
        }
